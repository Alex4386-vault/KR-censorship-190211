...
export const result = (isCensored: boolean): string => `\nResult:\n${isCensored ?
    `Your network is currently CENSORED! Please USE VPN to protect your privacy from government supervision!` :
    `This network is not censored, Enjoy your internet life.`}`;
